...
The Azure Linux Agent (typically called `WALinuxAgent` or `walinuxagent`) is required, and not all versions of the agent will work on Azure Stack. You should use either the latest version of WALA or version 2.2.20 if you create your own image. Versions of WALA between 2.2.20 and 2.2.36 (exclusive) will not work on Azure Stack. Note that [cloud-init](https://cloud-init.io/) is not supported on Azure Stack at this time.
